...
const FeaturedProjects = () => {
  ...
  const projectsBase = [
    { id: 1, image: 'https://images.unsplash.com/photo-1732371481436-c4510ceea581', alt: 'Groupe de jeunes adultes souriants lors d\'un événement culturel avec éclairage coloré et ambiance festive', stats: { reach: '500K+', engagement: '85%' } },
    { id: 2, image: 'https://img.rocket.new/generatedImages/rocket_gen_img_16fb3ceb8-1769245706130.png', alt: 'Étudiants universitaires diversifiés travaillant ensemble sur des ordinateurs portables dans une bibliothèque moderne lumineuse', stats: { reach: '200K+', engagement: '92%' } },
    { id: 3, image: 'https://img.rocket.new/generatedImages/rocket_gen_img_1b6d75657-1766483971279.png', alt: 'Équipe professionnelle en réunion stratégique autour d\'une table avec graphiques et présentations sur écran', stats: { reach: '150K+', engagement: '78%' } },
  ];
  const projectsTranslated = t.homepage.featuredProjects.projects;
  const projects: Project[] = projectsBase.map((p, i) => ({ ...p, ...projectsTranslated[i] }));
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground font-body max-w-2xl mx-auto">
            {t.homepage.featuredProjects.subtitle}
          </p>
        </div>
        ...
        <div className="relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12">
              <div className="max-w-3xl">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-primary-foreground/80 font-body">
                        {t.homepage.featuredProjects.reach}
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-primary-foreground/80 font-body">
                        {t.homepage.featuredProjects.engagement}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <button className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-cta font-semibold hover:bg-conversion-accent transition-all duration-300 shadow-brand hover:shadow-elevated transform hover:scale-105 flex items-center space-x-2">
                  <span>{t.homepage.featuredProjects.viewFullProject}</span>
          ...
          <div className="flex justify-center space-x-3 mt-8">
            ...
            <button
              ...
              aria-label={`${t.homepage.viewProjectAria} ${project.title}`} />
